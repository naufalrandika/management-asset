                ...
                <div class="col-md-8 offset-md-2">
                    ...
                    <div class="card my-4">
                        ...
                        <div class="card-body px-4 pt-3">
                            <form action="{{ route('berwujud.update', $berwujud->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <input type="text" name="kode" id="kode"
                                        ...
                                        value="{{ old('kode', $berwujud->kode) }}" required>
                                    @error('kode')
                                ...
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <input type="text" name="nama"
                                        ...
                                        value="{{ old('nama', $berwujud->nama) }}" required>
                                    @error('nama')
                                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                    @enderror
                                </div>
                                    ...
                                    <select name="jenis" id="jenis"
                                        ...
                                        @foreach ($jenisOptions as $jenisId => $jenisNama)
                                            <option value="{{ $jenisId }}"
                                                {{ old('jenis', $berwujud->jenis) == $jenisId ? 'selected' : '' }}>
                                                {{ $jenisNama }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="lokasi" id="lokasi"
                                        ...
                                        @foreach ($lokasiOptions as $lokasiId => $lokasiNama)
                                            <option value="{{ $lokasiId }}"
                                                {{ old('lokasi', $berwujud->lokasi) == $lokasiId ? 'selected' : '' }}>
                                                {{ $lokasiNama }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="keadaan" id="keadaan"
                                        ...
                                        @foreach ($keadaanOptions as $keadaanId => $keadaanNama)
                                            <option value="{{ $keadaanId }}"
                                                {{ old('keadaan', $berwujud->keadaan) == $keadaanId ? 'selected' : '' }}>
                                                {{ $keadaanNama }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <input type="text" name="masa_pemakaian"
                                        ...
                                        value="{{ old('masa_pemakaian', $berwujud->masa_pemakaian) }}">
                                ...
                                <div class="input-group input-group-static my-3">
                                    ...
                                    <input type="date" name="tanggal_terima"
                                        ...
                                        value="{{ old('tanggal_terima', $berwujud->tanggal_terima) }}">
                                ...
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <input type="text" name="Nilai"
                                        ...
                                        value="{{ old('Nilai', $berwujud->Nilai) }}" required>
                                    @error('Nilai')
                                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                    @enderror
                                </div>
                                    ...
                                    <select name="status" id="status"
                                        ...
                                        @foreach ($statusOptions as $statusId => $statusNama)
                                            <option value="{{ $statusId }}"
                                                {{ old('status', $berwujud->status) == $statusId ? 'selected' : '' }}>
                                                {{ $statusNama }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <textarea name="keterangan" class="form-control materialize-textarea @error('keterangan') is-invalid @enderror">{{ old('keterangan', $berwujud->keterangan) }}</textarea>
                                    @error('keterangan')
                                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                    @enderror
                                </div>
