                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Data Asset Tidak Berwujud</h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    <a href="{{ route('tberwujud.create') }}"
                                        class="btn btn-info btn-sm position-relative mx-3 z-index-2">
                                        Tambah
                                    </a>
                                    <a href="{{ route('tberwujud.downloadPDF') }}"
                                    ...
                                    <blockquote class="blockquote p-0 position-relative mx-3 z-index-2">
                                        <p class="text-uppercase text-secondary text-xxs font-weight-bolder">
                                            Aset tidak berwujud merujuk pada aset yang tidak memiliki bentuk fisik yang
                                            jelas dan tidak dapat dipegang. Meskipun tidak memiliki bentuk fisik, aset
                                            ini memiliki nilai ekonomi karena hak atau hak istimewa tertentu yang
                                            dimilikinya. Contoh dari aset tidak berwujud meliputi
                                            Merek dagang
                                            ,Hak paten
                                            ,Hak cipta
                                            ,Goodwill (nilai reputasi dan hubungan bisnis suatu perusahaan)
                                            ,Lisensi
                                            ,Franchise</p>
                                    </blockquote>
                                    <div class="dropdown position-relative mx-3 z-index-2">
                                        <form action="{{ route('tberwujud.index') }}" method="GET">
                                        ...
                                        @foreach ($data as $index => $datas)
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <a href="{{ route('tberwujud.edit', $datas->id) }}"
                                                ...
                                                <td class="align-middle">
                                                    <form action="{{ route('tberwujud.destroy', $datas->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
