<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    <x-navbars.sidebar activePage="laporan"></x-navbars.sidebar>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Laporan Data Semua Asset</h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <a href="{{ route('laporan.downloadPDF') }}"
                                        ...
                                        @foreach ($combinedData as $index => $datas)
                                            <tr>
                                                <td class="text-center text-xs font-weight-bold mb-0 ">
                                                    {{ $combinedData->firstItem() + $index }}</td>
                                                ...
                                                <td class="text-center mb-0 text-sm">{{ $datas->keterangan }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
