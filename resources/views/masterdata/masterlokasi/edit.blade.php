                ...
                <div class="col-md-8 offset-md-2">
                    ...
                    <div class="card my-4">
                        <div class="card-header bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Edit Master Lokasi</h6>
                        </div>
                        <div class="card-body px-4 pt-3">
                            <form action="{{ route('masterlokasi.update',$masterlokasi->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <input type="text" name="lokasi"
                                        ...
                                        value="{{ old('lokasi', $masterlokasi->lokasi) }}" required>
                                    @error('lokasi')
